...
//        ---
//
//        ## 🗄️ What Tables This Creates in PostgreSQL
//
//**`roadmaps` table:**
//        ```
//id | skill | level | duration | duration_type | include_practice |
//include_projects | include_revision | goals | ai_response | created_at
//```
//
//        **`quizzes` table:**
//        ```
//id | skill | difficulty | question_count | ai_response |
//correct_count | total_questions | percentage | skill_level | created_at*/
