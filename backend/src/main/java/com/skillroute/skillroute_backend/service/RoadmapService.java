...
import com.skillroute.skillroute_backend.dto.request.RoadmapRequest;
import com.skillroute.skillroute_backend.dto.response.RoadmapResponse;
import com.skillroute.skillroute_backend.entity.Roadmap;
import com.skillroute.skillroute_backend.repository.RoadmapRepository;
...
public class RoadmapService {
    ...
    public RoadmapResponse generateRoadmap(RoadmapRequest request) {
        try {
            ...
            RoadmapResponse roadmapData = groqService.extractJSON(aiResponse, RoadmapResponse.class);
    ...
    // ===================================
    private String buildRoadmapPrompt(RoadmapRequest req) {
    ...
    // Save to Database
    // ===================================
    private void saveToDatabase(RoadmapRequest request, String aiResponse) {
    ...
    public RoadmapResponse getRoadmapById(Long id) {
        ...
        try {
            return objectMapper.readValue(roadmap.getAiResponse(), RoadmapResponse.class);
        } catch (Exception e) {
